...
describe("BridgeMigrationRouter", async function() {
    ...
    before(async () => {
        ...
        const factory = await ethers.getContractAt("LilyswapFactory", fixture.Factory)
        const router = await ethers.getContractAt("LilyswapRouter", fixture.Router)
    ...
    beforeEach(async () => {
        ...
        factory = await ethers.getContractFactory("LilyswapBridgeMigrationRouter")
